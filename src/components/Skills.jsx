...
const Skills = () => {
	return (
		<section id='skills' className='pt-24'>
			...
			<div className="flex flex-col md:flex-row justify-center items-center md:items-stretch gap-5 py-16">
				<div className="text-center shadow-md rounded-xl w-[80%] md:w-[30%] flex flex-col px-6 py-3">
